 ...
 */
module org.metabit.platform.support.config.source.aws {
    ...
    exports org.metabit.platform.support.config.source.aws;

    provides org.metabit.platform.support.config.interfaces.ConfigStorageInterface 
        with org.metabit.platform.support.config.source.aws.AwsSecretsManagerConfigStorage;
}
