...
/**
 * mConfig source for AWS Secrets Manager.
 * Default scope: CLOUD.
 */
public final class AwsSecretsManagerConfigSource extends ConfigLocationImpl
{
    public AwsSecretsManagerConfigSource(ConfigScope scope, ConfigStorageInterface storage, ConfigFormatInterface format, Object handle)
    {
        super(scope, storage, format, handle);
    }

    public static AwsSecretsManagerConfigSourceBuilder builder()
    {
        return new AwsSecretsManagerConfigSourceBuilder();
    }
}
