...
/**
 * <p>SchemaDefaultConfigStorage class.</p>
 *
 * 
 * @version $Id: $Id
 */
public class SchemaDefaultConfigStorage implements ConfigStorageInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public URI getURIforConfigLocation(ConfigLocation configLocation, String key, String optionalFragment)
        ...
        String uristring = String.format("mconfig:schemadefaults/%s/%s", locationString, keyString); //@CHECK
     ...
     * {@inheritDoc}
     *
     * schemas have no dynamic creation/writing. This should never be called since schemas already state they're not for write access,
