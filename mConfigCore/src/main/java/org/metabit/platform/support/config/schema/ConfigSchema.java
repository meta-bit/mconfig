...
public interface ConfigSchema
{
    ...
    class statics
    {
        public static Map<String,ConfigSchema> fromJSON(final String jsonFormattedConfigScheme, ConfigFactoryInstanceContext ctx)
                throws ConfigCheckedException
            { throw new UnsupportedOperationException("JSON schema parsing is available in mConfigSchema module."); }
        public static ConfigSchema fromSchemaEntries(Set<ConfigSchemaEntry> entries) throws ConfigCheckedException { throw new UnsupportedOperationException("Schema creation from entries is available in mConfigSchema module."); }
    }
     */
}
