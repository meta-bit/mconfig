...
/**
 * Called after the ConfigFactory is fully initialized.
 * Allows the logger to refine its configuration (e.g., remote endpoints, tokens)
 * using the fully resolved configuration stack.
 *
 * @param factory the fully functional ConfigFactory instance
 */
default void postInit(final ConfigFactory factory)
    {
