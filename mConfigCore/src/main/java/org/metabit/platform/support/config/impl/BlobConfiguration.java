...
*/
    ...
    public ConfigEntry getConfigEntryFromFullKey(String fullKey, EnumSet<ConfigScope> scopes)
        ...
        try {
            ...
            return new GenericConfigEntryLeaf(fullKey, blobData, ConfigEntryType.BYTES, new ConfigEntryMetadata(null));
...
this is called from the Storage instances, function "updateConfigurationLayers"
...
so, for blobs, we need a corresponding getConfig() thing which calls corresponding
    //            storage.updateBlobConfigurations(sanitizedConfigName,location, blobCfg);
