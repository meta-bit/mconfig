...
import org.metabit.platform.support.config.schema.impl.*;
...
/**
 * <p>ConfigSchemaEntry class.</p>
 *
 * @version $Id: $Id
 */
public class ConfigSchemaEntry implements ConfigEntrySpecification
{
    ...
    private ConfigScope                                                       writeScope;
     ...
     * @return a {@link ConfigSchemaEntry} object
     *
     * @throws org.metabit.platform.support.config.ConfigCheckedException if any.
     */
    public ConfigSchemaEntry setDefault(String defaultStringValue)
     ...
     * @return a {@link ConfigSchemaEntry} object
     */
    public ConfigSchemaEntry setDescription(final String description)
        {
     ...
     * @return this entry
     */
    public ConfigSchemaEntry setDescription(String lang, String text)
        {
     ...
     * @return this entry
     */
    public ConfigSchemaEntry setDescriptions(Map<String, String> descriptions)
        {
     ...
     * @return a {@link ConfigSchemaEntry} object
     */
    public ConfigSchemaEntry setFlags(EnumSet<ConfigEntry.ConfigEntryFlags> flags)
        {
     ...
     * @return a {@link ConfigSchemaEntry} object
     */
    public ConfigSchemaEntry setValidator(final Pattern validator)
        {
     ...
     * @return this entry
     */
    public ConfigSchemaEntry setValidationPattern(String pattern)
        {
    ...
    public ConfigEntry getDefaultEntry()
        ...
        return new GenericConfigEntryLeaf(key, defaultValue, type, meta);
        }
    ...
    public ConfigSchemaEntry setSecret(boolean secret)
        {
    ...
    public ConfigSchemaEntry setMinArity(int minArity)
        {
    ...
    public ConfigSchemaEntry setMaxArity(int maxArity)
        {
    ...
    @Override
    public ConfigScope getWriteScope()
        {
        return writeScope;
        }

    public ConfigSchemaEntry setWriteScope(ConfigScope writeScope)
        {
    ...
    public void setTemporalValidationFlags(Map<String, Object> flags)
        ...
        if (flags != null && !flags.isEmpty())
            ...
            this.temporalValidator = new TemporalValidator(this.type, flags);
            }
        }
