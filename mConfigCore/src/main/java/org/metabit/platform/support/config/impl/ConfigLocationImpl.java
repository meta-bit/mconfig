...
public class ConfigLocationImpl implements ConfigLocation, ConfigSource
{
     ...
     * @throws ConfigException if scope or storage is null
     */
    ...
    public String toLocationString()
        ...
        if (storageInstanceHandle != null)
            ...
            switch (storageInstanceType)
                ...
                case FILE:
                case URI:
                    // prevent unintentional double slashes at start
                    if (!handleStr.startsWith("/") && !handleStr.startsWith("\\") && !handleStr.contains(":"))
                        {
                ...
                case OTHER:
                    ...
                    else if (storageInstanceHandle instanceof String)
                        {
                        // prevent unintentional double slashes at start
                        if (!handleStr.startsWith("/") && !handleStr.startsWith("\\"))
                            {
                            stringBuilder.append("/");
                            }
                        stringBuilder.append(handleStr);
