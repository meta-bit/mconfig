...
public interface ConfigFactoryBuilder
{
    ...
    /**
     * Set a feature value by interface.
     * @param feature the feature
     * @param value the value
     * @param <T> value type
     * @return the builder
     */
    <T> ConfigFactoryBuilder setFeature(ConfigFeatureInterface feature, T value);
     ...
     * @return the builder
     */
    ConfigFactoryBuilder setFeature(String featureName, Object value);
    ...
    /**
     * add an explicit config source.
     * for automated tests; not intended for regular API use.
     *
     * @param location the location of the source to add
     * @return the resulting ConfigFactoryBuilder
     */
    ConfigFactoryBuilder addSource(ConfigLocation location);
     ...
     * for testing and development; not intended for regular API use.
     *
