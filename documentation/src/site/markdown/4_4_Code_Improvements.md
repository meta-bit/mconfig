## 4.4. how to improve existing code?
...
- **Manual null handling for missing values:** Use `EXCEPTION_ON_MISSING_ENTRY=false` and `DEFAULT_ON_MISSING_ENTRY=true` to automatically return scheme defaults instead of `null`.
