...
This page provides various examples of configuration schemas, ranging from simple key-value pairs to complex nested structures with validation.

## 1. Simple Application Configuration

A basic schema for a small application with a few parameters.
