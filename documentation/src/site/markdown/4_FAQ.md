...
3. Verify placements per [Getting Started](getting-started.md#resource-placement-the-config-folder).
...
4. See full details in [Test Mode](test-mode.md).
...
### Environment variables not providing config values
