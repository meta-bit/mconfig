...
## 1.3.1 Include the library in your project build
...
For instant frustration-free setup, copy from [examples/starters](../../../../examples/starters/README.md):

- [![Maven](https://img.shields.io/badge/Maven-Minimal-blue)](../../../../examples/starters/maven-minimal/README.md) `mvn compile exec:java`
- [![Gradle](https://img.shields.io/badge/Gradle-Kotlin-green)](../../../../examples/starters/gradle-kotlin/README.md) `./gradlew run`
- [![JPMS](https://img.shields.io/badge/JPMS-Maven-orange)](../../../../examples/starters/jpms-maven/README.md) `mvn compile exec:java` (module-info included!)
...
## 1.3.2 Start with a simple use case
...
## 1.3.5 Search List and Priority
...
## 1.3.7 Module System Considerations
