...
Proceed to the [Getting Started](getting-started.md) section for step-by-step instructions on integrating mConfig into your project, including dependencies, first code examples, and resource placement.
