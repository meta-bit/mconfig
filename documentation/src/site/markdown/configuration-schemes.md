...
### 2.5.1.1 Benefits of using Schemes
...
### 2.5.3.3 Validation Patterns (`PATTERN`)
...
### 2.5.3.4 Internationalization (I18N)
...
## 2.5.5 Future-Proofing with the `MANDATORY` block
...
### 2.5.6.2 List of Entries (Anonymous Scheme)
